...
class DatabaseService{
  ...
  final CollectionReference personalInfoColletion = FirebaseFirestore.instance.collection('personalInfo');
  Future updataUserData(String fullname,
                        String dob,
                        String phonenumber ,
                        int age ,
                        String address,
  ...
  Stream<UserData> get personalInfo{
    return personalInfoColletion.doc(uid).snapshots()
